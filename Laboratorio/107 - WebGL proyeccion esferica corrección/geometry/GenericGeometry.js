class GenericGeometry {
  ...
  createFlatVAO(gl) {
    ...
    //////////////////////////////////////////////////
    if ((this.getUVCoordinates) && (this.material.getAttribute("a_texcoord") != undefined)) {
      // Se le pasa como segundo parámetro el valor de true, para que utilice la corrección en el calculo de las coordenadas UV
  ...
  /**
   */
  draw(gl, projectionMatrix, viewMatrix, light, param_t) {
    ...
    // u_t
    if (this.material.getUniform("u_t") != undefined) {
      gl.uniform1f(this.material.getUniform("u_t"), param_t);
    }
