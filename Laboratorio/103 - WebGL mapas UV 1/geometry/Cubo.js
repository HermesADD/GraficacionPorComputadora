class Cubo {
  ...
  constructor(gl, material=new FlatMaterial(gl), transform=identity()) {
    ...
    // hay que notar que como las coordenadas UV son bidimensionales, el número de elementos indicados es 2 (segundo parámetro de la función vertexAttribPointer)
