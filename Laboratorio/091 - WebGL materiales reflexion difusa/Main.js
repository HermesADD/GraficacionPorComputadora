window.addEventListener("load", function(evt) {
  ...
  let geometry = [
    new Suzanne(
      gl, 
      new ReflexionDifusaMaterial(gl, [1,1,1], [243/255, 156/255, 18/255, 1]), // material
    ...
    new Esfera(
      ...
      16, // Nu
      16, // Nv
      new ReflexionDifusaMaterial(gl, [0.9,0.9,0.9], [243/255, 156/255, 18/255, 1]), // material
      translate(-6, 0, 0) // transformación
    ),
    new Teapot(
      gl, 
      new ReflexionDifusaMaterial(gl, [0.8,0.8,0.8], [243/255, 156/255, 18/255, 1]), // material
      translate(6, 0, 0) // transformación
    ),
    new PrismaRectangular(
      ...
      4, //h
      4, //l
      new ReflexionDifusaMaterial(gl, [0.7,0.7,0.7], [243/255, 156/255, 18/255, 1]), // material
      translate(0, 6, 0) // transformación
    ),
    new Engrane(
      gl, 
      new ReflexionDifusaMaterial(gl, [0.6,0.6,0.6], [243/255, 156/255, 18/255, 1]), // material
      translate(0, -6, 0) // transformación
    ),
  ];
  ...
  function draw() {
    ...
    for (let i=0; i<geometry.length; i++) {
      geometry[i].draw(gl, projectionMatrix, viewMatrix, diffuseLightColor, lightPosTrans);
    }
  }
