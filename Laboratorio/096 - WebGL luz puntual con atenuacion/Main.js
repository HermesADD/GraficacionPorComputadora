window.addEventListener("load", function(evt) {
  ...
  let light = new LuzPuntualAtenuacion(
    // debido a la atenuación la posición de la luz es muy lejana y los objetos se ven oscuros, es posible usar una luz más cercana por ejemplo: { x: 2.5, y: 3.75, z: 1.25 },
    { x: 20, y: 30, z: 10 }, // posición 
    [ 0.2, 0.2, 0.2 ], // component ambiental
    [ 1, 1, 1 ], // componente difuso
    [ 1, 1, 1 ], // componente especular
    0.01, // coeficiente cuadrático
    0.22, // coeficiente lineal
    0.03  // coeficiente constante
  );
