class GenericGeometry {
  ...
  /**
   */
  draw(gl, projectionMatrix, viewMatrix, light, color_texture, bloom_texture) {
    ...
    // u_bloom_texture
    if (this.material.getUniform("u_bloom_texture") != undefined) {
      gl.activeTexture(gl.TEXTURE1);
      gl.bindTexture(gl.TEXTURE_2D, bloom_texture);
      gl.uniform1i(this.material.getUniform("u_bloom_texture"), 1);
    }
    ////////////////////////////////////////////////////////////
