class PhongMaterial extends Material {
  constructor(gl, Ka=[0,0,0], Kd=[0,0,0], Ks=[0,0,0], shininess=1) {
    ...
    // La luz se vuelve un arreglo de la estructura Light; es importante indicar el número de luces que se van a utilizar, en este caso 3, esto debido a que se asigna memoria para almacenar el arreglo de luces
