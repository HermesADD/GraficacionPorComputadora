class FramebufferBlurMaterial extends Material {
  constructor(gl) {
    ...
    void main() {
      vec4 blurHorizontal = blur(u_texture, vec2(1,0), v_texcoord);
      vec4 blurVertical = blur(u_texture, vec2(0,1), v_texcoord);
      
      pixelColor = (blurHorizontal + blurVertical)/2.0;
    }`;
