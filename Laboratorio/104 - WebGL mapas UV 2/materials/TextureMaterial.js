class TextureMaterial extends Material {
  constructor(gl, image) {
    ...
    // Uniforme para comunicar el valor de la barra
    uniform float u_t;

    void main() {
      // Se realiza una interpolación lineal entre la posición de los vértices del cubo y las coordenadas de textura
      vec4 pos = vec4((1.0-u_t)*a_position.xyz + u_t * vec3(4.0*a_texcoord-2.0, 0), 1);

      v_texcoord = a_texcoord;

      gl_Position = u_PVM_matrix * pos;
    }`;
