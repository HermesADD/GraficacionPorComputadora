class PhongMaterial extends Material{
    constructor(gl, ka=[0,0,0], kd=[0,0,0], ks=[0,0,0], alpha=1, color=[1,1,1,1]) {
        ...
        let fragmentShaderSource =
            ...
            vec3 especular(vec3 L, vec3 N) {
                ...
                vec3 V2 = normalize( vec3(0,0,0) - v_position );

                // El coseno del ángulo entre la dirección de la luz y la normal del fragmento
                float cos_phi = max(dot(R, V2), 0.0);
